<?php
/**
 * Post API: Visa4_Page_DropDown class
 *
 * (Copied from WP)
 */
 ...
 * @see Walker
 */
class Visa4_Page_DropDown extends Walker {
    ...
    public function start_el( &$output, $page, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if ( $args['attach_editlink'] )
            $output .= ' data-editlink="'. html_entity_decode( get_edit_post_link( $page->ID ) ) .'"';
